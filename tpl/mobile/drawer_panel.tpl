...
<core-header-panel navigation flex>
    ...
    <core-menu selected="{$args}">
        ...
        <core-item icon="assignment" label="Protokolle"><a href="index.php?p=3" target="_self"><paper-ripple fit></paper-ripple></a></core-item>
        <core-item icon="account-balance" label="Staat"><a href="index.php?p=3" target="_self"><paper-ripple fit></paper-ripple></a></core-item>
