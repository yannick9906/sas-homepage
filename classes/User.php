...
class User {
    ...
    public function getPrefixAsHtml() {
        switch($this->uPrefix) {
            case 0:
                return '<span class="black-text">[User]</span>';
                break;
            case 1:
                return '<span class="black-text">[Partei]</span>';
                break;
            case 2:
                return '<span class="orange-text">[Ak]</span>';
                break;
            case 3:
                return '<span class="orange-text">[Orga]</span>';
                break;
            case 4:
                return '<span class="orange-text">[Lehrer]</span>';
                break;
            case 5:
    ...
    public static function getAllUsers($sort = "", $filter = "") {
        $pdo = new PDO_MYSQL();
        $stmt = $pdo->queryMulti('SELECT uID FROM schlopolis_user'.UFILTERING[$filter].' '.USORTING[$sort]);
