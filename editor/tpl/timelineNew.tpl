...
<main>
    <div class="container">
        <div class="card-panel row">
            <br/>
            <form action="timeline.php?action=postNew" method="post" id="form">
                ...
                <div class="input-field col s12">
                    <select id="type" title="Type" name="type">
                        ...
                        <option data-icon="../libs/vertical-timeline/img/cd-icon-voting-bg.svg" class="left circle" value="1">Abstimmung</option>
                        <option data-icon="../libs/vertical-timeline/img/cd-icon-down-bg.svg" class="left circle" value="2">Start</option>
                        <option data-icon="../libs/vertical-timeline/img/cd-icon-up-bg.svg" class="left circle" value="3">Ende</option>
                    </select>
