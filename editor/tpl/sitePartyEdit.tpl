        ...
        <div class="col s12 m6 card-panel row">
            ...
            <form action="sites.php?action=postEdit&pID={$edit.id}" method="post" id="form">
                <div class="input-field col s12">
                    ...
                    <input id="title" value="{$edit.name}" required type="text" name="name" required length="255"/>
                </div>
                <div class="input-field col s12">
                ...
                <div class="input-field col s12">
                    <label for="short">Kurz Info</label>
                    <input id="short" value="{$edit.short}" required type="text" name="short" required length="1023"/>
                </div>
                <div class="input-field col s12">
                    <textarea id="text" name="text" required class="materialize-textarea" length="62337">{$edit.text}</textarea>
                    <label for="text">Text <i class="mdi mdi-markdown"></i>[GitHub flavored Markdown supported]</label>
                </div>
            </form>
        </div>
