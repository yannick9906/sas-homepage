                ...
                <tbody>
                    {loop $page.items}
                        ...
                        <tr>
                            ...
                            <td style="">
                                <a {if !(!$state == 0 and $_.perm.timeline_approve == 1)}class="disabled"{else}href="timeline.php?action=approve&vID={$vId}" class="approve"{/if}><i class="mdi mdi-check"></i></a><a {if !(!$state == 0 and $_.perm.timeline_approve == 1)}class="disabled"{else}href="timeline.php?action=deny&vID={$vId}" class="deny"{/if}><i class="mdi mdi-close"></i></a>
                                <a {if $_.perm.timeline_newVersion == 1}href="timeline.php?action=edit&tID={$id}" class="normal"{else}class="disabled"{/if}><i class="mdi mdi-pencil"></i></a><a {if $_.perm.timeline_view == 1}href="timeline.php?action=vers&tID={$id}" class="normal" {else} class="disabled"{/if}><i class="mdi mdi-clock"></i></a><a {if $_.perm.admin_timeline_del == 1}href="timeline.php?action=del&vID={$vId}" class="normal"{else}class="disabled"{/if}><i class="mdi mdi-delete"></i></a><br/>
